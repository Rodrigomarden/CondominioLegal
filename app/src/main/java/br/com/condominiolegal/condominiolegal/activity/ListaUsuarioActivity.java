...
import br.com.condominiolegal.condominiolegal.adapter.ListaUsuarioAdapter;
...
public class ListaUsuarioActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        toolbar = (Toolbar) findViewById(R.id.tb_lista_usuario);
        ...
        listView = (ListView) findViewById(R.id.lv_lista_usuario);
        adapter = new ListaUsuarioAdapter(this, listaUsuario);

        listView.setAdapter(adapter);

        query = ConfiguracaoFirebase.getFirebase().child("usuarios").orderByChild("nome");
        ...
        listView.setOnItemClickListener(new AdapterView.OnItemClickListener() {
            ...
            public void onItemClick(AdapterView<?> adapterView, View view, int i, long l) {
                ...
                Intent intent = new Intent(ListaUsuarioActivity.this, EditarUsuarioActivity.class);
                intent.putExtra("usuario", listaUsuario.get(i));
        ...
        listView.setOnItemLongClickListener(new AdapterView.OnItemLongClickListener() {
            ...
            public boolean onItemLongClick(AdapterView<?> adapterView, View view, final int position, long l) {
                ...
                //Criar alert dialog
                dialogDelete = new AlertDialog.Builder(ListaUsuarioActivity.this);
                ...
                dialogDelete.setPositiveButton("Sim", new DialogInterface.OnClickListener() {
                    ...
                    public void onClick(DialogInterface dialogInterface, int i) {
                        ...
                        firebase = ConfiguracaoFirebase.getFirebase().child("usuarios").child(listaUsuario.get(position).getId());
